-- =============================================================================
-- Ava Platform - Migration 001: Compliance Infrastructure
-- =============================================================================
-- Migration: 001
-- Date: 2026-02-23
-- Description: Create audit_log and takedown_requests tables with indexes
--              and append-only trigger protection
-- Requirements: PostgreSQL 14+ (uses gen_random_uuid())
-- =============================================================================

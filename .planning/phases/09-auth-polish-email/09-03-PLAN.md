...
<task type="auto">
  ...
  <action>
**LoginPage.tsx** — Add Google button ABOVE the form with "or" divider, add "Forgot password?" link, add Google-only account error handling:
...
```
  ...
  <verify>
    ...
    <manual>
      ...
      - LoginPage has "Forgot password?" link at the bottom
  ...
  <done>
    ...
    LoginPage has GoogleSignInButton above the form + "Forgot password?" link.
...
- `LoginPage.tsx` has GoogleSignInButton above form + "or" divider + "Forgot password?" link
